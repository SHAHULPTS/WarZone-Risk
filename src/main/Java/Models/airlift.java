...
public class Airlift implements Card {
    ...
    public void execute(GameState p_gameState) {
        if (valid(p_gameState)) {
            Country sourceCountry = p_gameState.getD_map().getCountryByName(d_sourceCountryName);
            Country targetCountry = p_gameState.getD_map().getCountryByName(d_targetCountryName);
            Integer updatedTargetArmies = targetCountry.getD_armies() + this.d_numberOfArmies;
            Integer updatedSourceArmies = sourceCountry.getD_armies() - this.d_numberOfArmies;
