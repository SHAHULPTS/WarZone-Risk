...
public class PlayerTest {
    ...
    public void setup() {
        ...
        d_exisitingPlayerList.add(new Player("Surya"));

        Map l_map = new Map();
        Country l_c1 = new Country(1, "Greece", 10);
        l_c1.setD_adjacentCountryIds(Arrays.asList(2));
        Country l_c2 = new Country(2, "Iceland", 10);
    ...
    public void testNextOrder() {
        ...
        Order l_deployOrder2 = new Deploy(d_exisitingPlayerList.get(1), "Greece", 6);
    ...
    public void testCountryExists() {
        ...
        assertTrue(l_player.checkAdjacency(l_gs, "Greece", "Iceland"));
        assertFalse(l_player.checkAdjacency(l_gs, "Iceland", "Greece"));
    }
    ...
    public void testCreateAdvanceOrder() {
        ...
        l_player.createAdvanceOrder("advance Greece Iceland 10", l_gs);
    ...
    public void testCreateAdvanceOrderFailure() {
        Player l_player = new Player("xyz");
        l_player.createAdvanceOrder("advance Iceland Greece 0", l_gs);
